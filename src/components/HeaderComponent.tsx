	...
	return (
		<>
			<div className="sticky top-0 z-10 px-4 mx-auto max-w-4xl text-black bg-dark dark:bg-black">
				<header className="text-black dark:text-white bg-white dark:bg-black">
					<div className="mx-auto py-4 flex justify-between items-center bg-white dark:bg-black">
						<div className="flex items-center">
							<Link href="/">
								<h1
									className={`font-bold tracking-wider uppercase ${isMobile ? "text-xl" : "text-xl"}`}
								>
									{isMobile ? <CalendarRange /> : "Contacts"}
								</h1>
							</Link>
						</div>
